...
public class TransferController {
    ...
    public TransferController(WebClient.Builder webClientBuilder, ProfileClient profileClient, TransferService transferService) {
    ...
    @PostMapping()
    public Mono<ApiResponse<Bank>> transfer(@RequestBody Transfer transfer) {
        try{
            return webClient.get()
                    .uri("/profile/users/{id}") // Thay thế {id} bằng ID người dùng
    ...
    @GetMapping()
    public Mono<ApiResponse<Bank>> getBanks(@RequestBody Transfer transfer) {
        try{
            return webClient.get()
                    .uri("/profile/users/{id}") // Thay thế {id} bằng ID người dùng
                    .retrieve()  // Thực hiện GET request
